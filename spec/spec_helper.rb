...
RSpec.configure do |c|
  ...
  CSV_COL_CAPITALIZED_INTERESTS_BEGINNING_OF_PERIOD = 13
  CSV_COL_CAPITALIZED_INTERESTS_END_OF_PERIOD = 14
  ...
  INTERESTS_RELATED_COLUMNS = [
    ...
    CSV_COL_CAPITALIZED_INTERESTS_BEGINNING_OF_PERIOD,
    CSV_COL_CAPITALIZED_INTERESTS_END_OF_PERIOD
  ].freeze
end
